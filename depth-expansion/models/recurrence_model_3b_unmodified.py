...
class LocalModelConfig:
    ...
    # GSA — scale heads with hidden: 768 / 64 = 12
    gsa_num_heads     = 12
    gsa_head_dim      = 64
    gsa_k_base        = 32
    gsa_k_min         = 4
    ...
    # MoE — 4 real + 4 null experts; smaller FFN matching ~170M total param budget
    num_real_experts   = 4
    num_null_experts   = 4
...
def create_model_3b(embedding_type="kronecker", bpe_vocab=None, pf_codec=None, local=False):
    """
